...
#read RLE file
# with open("GoL\\gosperglidergun.rle", "r") as text_file:
#     rleString = text_file.read()

with open("GoL\\turingmachine.rle", "r") as text_file:
    rleString = text_file.read()

# with open("GoL\\90p51.rle", "r") as text_file:
#     rleString = text_file.read()

# with open("GoL\\ak94.rle", "r") as text_file:
#     rleString = text_file.read()

# with open("GoL\\4enginecordership.rle", "r") as text_file:
#     rleString = text_file.read()
